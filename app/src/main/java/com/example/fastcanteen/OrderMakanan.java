...
public class OrderMakanan extends AppCompatActivity {
//
...
//        setContentView(R.layout.activity_order_makanan);
//
...
//                Intent intent = new Intent(OrderMakanan.this, FormPemesanan.class);
